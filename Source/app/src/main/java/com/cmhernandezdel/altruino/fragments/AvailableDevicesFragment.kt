 ...
 * Use the [AvailableDevicesFragment.newInstance] factory method to
...
class AvailableDevicesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AvailableDevicesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AvailableDevicesFragment().apply {
